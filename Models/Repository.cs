namespace FormsApp.Models
{
    public class Repository
    {
        ...
        static Repository()
        {
            ...
            _products.Add(new Product{ ProductId=5, Name="Macbook Pro", Price=80000, IsActive=true, Image="5.jpg",CategoryId=2});
            _products.Add(new Product{ ProductId=6, Name="Macbook Air", Price=90000, IsActive=true, Image="6.jpg",CategoryId=2});
